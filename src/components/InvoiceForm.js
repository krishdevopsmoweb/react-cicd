...
class InvoiceForm extends React.Component {
  ...
  handleAddEvent() {
    ...
    this.setState(prevState => ({ items: [...prevState.items, item] }), () => this.handleCalculateTotal());
  }

  handleCalculateTotal() {
    const items = this.state.items;
    let subTotal = items.reduce((acc, item) => acc + parseFloat(item.price) * parseInt(item.quantity), 0);
            ...
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              ...
              <Row className="mb-5">
                <Col>
                  ...
                  <Form.Control placeholder="Who is this invoice to?" type="text" value={this.state.billTo} name="billTo" className="my-2" onChange={this.editField} autoComplete="name" required />
                  <Form.Control placeholder="Email address" type="email" value={this.state.billToEmail} name="billToEmail" className="my-2" onChange={this.editField} autoComplete="email" required />
                  <Form.Control placeholder="Billing address" type="text" value={this.state.billToAddress} name="billToAddress" className="my-2" onChange={this.editField} autoComplete="address" required />
                </Col>
                <Col>
                  <Form.Label className="fw-bold">Bill from:</Form.Label>
                  <Form.Control placeholder="Who is this invoice from?" type="text" value={this.state.billFrom} name="billFrom" className="my-2" onChange={this.editField} autoComplete="name" required />
                  <Form.Control placeholder="Email address" type="email" value={this.state.billFromEmail} name="billFromEmail" className="my-2" onChange={this.editField} autoComplete="email" required />
                  <Form.Control placeholder="Billing address" type="text" value={this.state.billFromAddress} name="billFromAddress" className="my-2" onChange={this.editField} autoComplete="address" required />
                </Col>
              </Row>
              ...
              <Form.Control placeholder="Thanks for your business! with us for ci cd by me" name="notes" value={this.state.notes} onChange={this.editField} as="textarea" className="my-2" rows={1} />
            </Card>
          </Col>
