        ...
        <Row>
          <Col md={8} lg={9}>
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              ...
              <Form.Control placeholder="Thanks for your business! with us for ci cd" name="notes" value={this.state.notes} onChange={this.editField} as="textarea" className="my-2" rows={1} />
            </Card>
          </Col>
